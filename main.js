...
block.addEventListener('click', ()=>{
    console.log('click')
    if (block.style.backgroundColor === 'rgb(255, 0, 255)') {
        block.style.backgroundColor = 'rgb(127, 255, 212)'
    } else if (block.style.backgroundColor === 'rgb(127, 255, 212)'){
        block.style.backgroundColor = 'rgb(255, 0, 255)'
    }
})

document.getElementById('bt_shdw').addEventListener('click', showDiv);

let mdiv = true;
function showDiv(){
    let isShow = document.getElementById('card_3');
    if(mdiv){
